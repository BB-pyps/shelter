console.log('Самопроверка:/n 1.Реализация burger menu на обеих страницах: +26/n 2. Реализация слайдера-карусели на странице Main: +36/n 3. Реализация пагинации на странице Pets: 0 /n 4. Реализация попап на обеих страницах: +12 /n Добрый день, у меня не реализована пагинация, если будет такая возможность - проверьте мою работу в четверг./n Спасибо за понимание =)');
